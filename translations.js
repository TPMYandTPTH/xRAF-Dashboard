const translations = {
    en: {
        ...
        paymentTermsText2: "RM50 will be paid when the candidate passes the assessment. RM750 bonus will be paid only after your referred candidate successfully completes the 90-day probation period.",
        ...
        previouslyAppliedNoteText: "No payment will be made if the candidate has previously applied to TP",
        startReferring: "Start referring friends to see them here",
        referFriend: "Refer a Friend",
        statusExternalPortal: "External Portal",
